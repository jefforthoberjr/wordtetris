...
from views.controls_screen import ControlsScreen
...
main_menu_screen = MainMenuScreen(window, screen_manager, ScreenType.MODE_SELECT,
                                  ScreenType.DICTIONARY, ScreenType.CONTROLS,
                                  ScreenType.DEBUG_MENU)
mode_select_screen = ModeSelectScreen(window, screen_manager,
                                      ScreenType.MAIN_MENU, start_game_mode)
controls_screen = ControlsScreen(window, screen_manager, ScreenType.MAIN_MENU)
...
screen_manager.register(ScreenType.CONTROLS, controls_screen)
