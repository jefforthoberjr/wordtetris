...
class SquareTetriminoType(Enum):
    I = 1
    O = 2
    T = 3
    S = 4
...
SQUARE_TETRIMINO_SHAPES = {
    SquareTetriminoType.I: [
        (0, 0), (1, 0), (2, 0), (3, 0)
    ],
    SquareTetriminoType.O: [
        (0, 0), (1, 0), (0, 1), (1, 1)
    ],
    SquareTetriminoType.T: [
        (0, 0), (1, 0), (2, 0), (1, 1)
    ],
    SquareTetriminoType.S: [
        (0, 0), (1, 0), (1, 1), (2, 1)
    ],
    SquareTetriminoType.Z: [
        (1, 0), (2, 0), (0, 1), (1, 1)
    ],
    SquareTetriminoType.J: [
        (0, 0), (0, 1), (1, 1), (2, 1)
    ],
    SquareTetriminoType.L: [
        (2, 0), (0, 1), (1, 1), (2, 1)
    ],
}
